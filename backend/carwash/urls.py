...
from .views import (
    ...
    ListCarWashAPIView,
    S3APIView,
    CarWashReviewCreateView,
    CarWashReviewRetrieveUpdateDestroyView,
    ListCarWashReviewAPIView,
    OfferCreateView,
    OfferRetrieveUpdateDestroyView,
    ListOfferAPIView,
    ListFreeCarWashCodeAPIView,
...
urlpatterns = [
    ...
    path(
        "reviews/create/",
        CarWashReviewCreateView.as_view(),
        name="create-car-wash-review",
    ),
    path(
        "reviews/<int:id>/",
        CarWashReviewRetrieveUpdateDestroyView.as_view(),
        name="get-patch-delete-car-wash-review",
    ),
    path(
        "reviews/search/",
        ListCarWashReviewAPIView.as_view(),
        name="list-car-wash-review",
    ),
    ...
    path(
        "car-wash-codes/mark-used/",
        CarWashCodeMarkAsUsedView.as_view(),
        name="car-wash-codes-mark-used",
    ),
    path(
        "car-wash-codes/free-codes/",
        ListFreeCarWashCodeAPIView.as_view(),
        name="free-car-wash-codes-list",
    ),
    path(
    ...
    path(
        "payment-status/<str:payment_intent_id>/",
